      ...
      <Fragment>
        <main className={`${styles['main']} ${styles['display-main']}`}>
          ...
          <div className={styles['header-center']}>
            ...
            <div className={`${styles['header-center-div']} ${styles['header-center-div-page']}`}>
              <span
                onClick={() => {
                  this.state.pages === 'none' ? this.setState({ pages: 'block' }) : this.setState({ pages: 'none' });
                }}
              >
                <p className={styles['header-center-text']}>PAGES</p>
              </span>
              <img className={styles['chevron']} src={chev} alt="img" />
              <ul style={{ display: this.state.pages }} className={styles['header-center-div__contents']}>
            ...
            <div className={`${styles['header-center-div']} ${styles['header-center-div-shop']}`}>
              <span
                onClick={() => {
                  this.state.shop === 'none' ? this.setState({ shop: 'block' }) : this.setState({ shop: 'none' });
                }}
              >
                <p className={styles['header-center-text']}>SHOP</p>
              </span>
              <img className={styles['chevron']} src={chev} alt="img" />
              <ul style={{ display: this.state.shop }} className={styles['header-center-div__contents']}>
          ...
          <div className={styles['header-right']}>
            ...
            <div
              onClick={() => {
                this.state.menu === 'none' ? this.setState({ menu: 'block' }) : this.setState({ menu: 'none' });
              }}
