        ...
        <main className={styles["main"]}>
          ...
          {cartData.length === 0 ?
                 ...
                 <div>
                   ...
                   <p>Donec nunc nunc, gravida vitae diam vel, varius interdum erat. Quisque a nunc vel diam auctor commodo. urabitur blandit ultri</p>
                 </div>
               </section>:
            ...
            <aside className={styles["aside-left"]}>
              ...
              <div className={styles["cart-bottom-div"]}>
                <div className={styles["apply-div"]}>
                  ...
                  />
                  <button className={styles["coupon-btn"]}>Apply Coupon</button>
                </div>
