      ...
      <main className={styles['main-2']}>
        <main className={styles['main']}>
          ...
          <section className={styles['section-1']}>
            ...
            <p className={styles['section-1-text']}>Pay and get your ordered items</p>
          </section>
          <section className={styles['section-2']}>
            <h1 className={styles['self']}>Self Information</h1>
            <input className={styles['input-1']} type="text" placeholder="Your Name *" onChange={name_user} />
            <input className={styles['input-1']} type="text" placeholder="Address *" onChange={address} />
            <div className={styles['phone-div']}>
              <div className={styles['code-div']}>
                <p>+62</p>
                <img src={chev} alt="img" />
              </div>
              <input className={styles['input-2']} type="text" placeholder="Phone Number *" onChange={phone} />
            </div>
