      ...
      <main className={styles["main"]}>
        ...
        <section>
              ...
              <div div className={styles['content_all']}>
                <div className={styles['content_left']}>
                  ...
                  <div className={styles['img_banner']}>
                    <img className={styles['icon_banner']} src={icon_banner} alt="icon_banner" />
                  </div>
                </div>
                <div className={styles['content_right']}>
                  <img className={styles['img_freshii']} src={img_freshii} alt="img_freshii" />
                  ...
                  <div className={styles['content_text_time']}>
                    ...
                    <span className={styles['text_tag']}>
                      <img className={styles['icon_tag']} src={icon_tag} alt="icon_tag" />
          ...
          <div className={styles['img_relate_post']}>
            ...
            <div className={styles['content_relate_img']}>
              <img className={styles['img_chair']} src={img_chair} alt="img_chair" />
              <p className={styles['text_furniture']}>Furniture Vintage Style</p>
              <div className={styles['content_text_time']}>
