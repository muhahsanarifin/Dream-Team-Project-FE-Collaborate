        ...
        <section>
          <div>
            ...
            >
              <p className={styles["text_blog"]}>
                ...
                <span className={styles["text_blog_detail"]}>Blog Detail</span>
              </p>
              ...
              <div div className={styles["content_all"]}>
                <div className={styles["content_left"]}>
                  ...
                  <div className={styles["content_tags"]}>
                    <div className={styles["content_border_tags"]}>
                      furniture
                    </div>
                    ...
                    <div className={styles["content_border_online"]}>
                      online store
                    </div>
                    <div className={styles["content_border_tags"]}>
                      real estate
                ...
                <div className={styles["content_right"]}>
                  ...
                  <article>
                    <p className={styles["describe_interior"]}>
                      ...
                      Voluptate explicabo quae vel nihil veniam laboriosam quod,
                      labore reprehenderit enim corrupti! Quae quasi ab, tempore
                      quos eveniet harum ex soluta explicabo totam accusantium
                      numquam maxime quibusdam fugiat autem aliquid natus rerum
                      nam architecto tenetur repudiandae exercitationem
                      doloremque inventore cumque? Vero facilis voluptatum
                      obcaecati, ex id nobis placeat explicabo dolore, quisquam
                      a harum, facere vel quos sequi quas doloremque unde magnam
                      illum ipsam laudantium mollitia inventore! Dolorum,
                      officiis quae vel autem molestias, possimus sint vero
                      molestiae praesentium optio asperiores? Eum, atque tempore
                      tenetur unde veritatis nobis iure rerum commodi
                    ...
                    <div className={styles["content_scandinavian"]}>
                      <img
                        className={styles["img_kitchen"]}
                        src={img_kitchen}
                        alt="img_kitchen"
                      />
                      <div className={styles["content_scandi"]}>
                        <p className={styles["text_Scandinavian"]}>
                          {" "}
                          Scandinavian Design
                        </p>
                        <span className={styles["text_scan"]}>
                          Lorem ipsum dolor sit, amet consectetur adipisicing
                          elit. Voluptate explicabo quae vel nihil veniam
                          laboriosam quod, labore reprehenderit enim corrupti!
                          Quae quasi ab, tempore quos eveniet harum ex soluta
                          explicabo totam accusantium numquam maxime quibusdam
                          fugiat autem aliquid natus rerum nam architecto
                          tenetur repudiandae exercitationem doloremque
                          inventore cumque? Vero facilis voluptatum obcaecati,
                          ex id nobis placeat explicabo dolore, quisquam a
                          harum,
                        </span>
                        <br />
                        <span className={styles["text_scan"]}>
                    ...
                    <div className={styles["content_luxury"]}>
                      ...
                      <div className={styles["content_text_luxury"]}>
                        <div className={styles["text_luxury"]}>
                          {" "}
                          "Luxury Is In Each Detail"{" "}
                        </div>
                        <div className={styles["text_hubert"]}>
                    ...
                    <div className={styles["content_post"]}>
                      ...
                      <div className={styles["content_post_right"]}>
                        ...
                        <div className={styles["text-recent"]}>
                          Windows Registry Cleaner <br />{" "}
                          <span className={styles["cheklist"]}>Cheklist</span>
                          <p className={styles["text-time-right"]}>
                            24 april 2019 : 45 mins ago
                          </p>
                        </div>
                      </div>
          ...
          <div className={styles["img_relate_post"]}>
            <div className={styles["content_relate_img"]}>
              <img
                className={styles["img_relate"]}
                src={img_freshii}
                alt="img_freshii"
              />
              <p className={styles["text_interior"]}>
                How to open interior shop?
              </p>
              <div className={styles["content_text_time"]}>
            ...
            <div className={styles["content_relate_img"]}>
              <img
                className={styles["img_matress"]}
                src={img_matress}
                alt="img_matress"
              />
              <p className={styles["text_beatiful"]}>Beatiful Corner</p>
              <div className={styles["content_text_time"]}>
                <span className={styles["text_relate_corner"]}>
                  <img
                    className={styles["icon_time"]}
                    src={icon_time}
                    alt="icon_time"
                ...
                <span className={styles["text_kids_corner"]}>
                  <img
                    className={styles["icon_tag"]}
                    src={icon_tag}
                    alt="icon_tag"
            ...
            <div className={styles["content_relate_img"]}>
              <img
                className={styles["img_chair"]}
                src={img_chair}
                alt="img_chair"
              />
              <p className={styles["text_furniture"]}>
                Furniture Vintage Style
              </p>
              <div className={styles["content_text_time"]}>
                <span className={styles["text_relate_vintage"]}>
                  <img
                    className={styles["icon_time"]}
                    src={icon_time}
                    alt="icon_time"
                ...
                <span className={styles["text_kids_vintage"]}>
                  <img
                    className={styles["icon_tag"]}
                    src={icon_tag}
                    alt="icon_tag"
